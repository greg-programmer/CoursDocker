...
# Build de notre image docker, se placer dans le repertoire Back-api-node
$ docker build -t back-api-node .

# Build de notre image docker, se placer dans le repertoire Front-React
$ docker build -t front-api-react .

# se placer dans le repertoire ApiContact 
